...
import App from './App';
import { HatcheryBrief, PLTWBrief } from './projectDefs.js';
  ...
  render() {
    return (
      <div style={{width: "60%", margin: "auto"}}>
        ...
        <div >
          <a class="button is-link is-large is-fullwidth is-outlined" style = {{marginTop: "20px", marginBottom: "20px"}}>Projects</a>
  ...
  render() {
    ...
    return (
      <div>
        ...
        <TextSlide id = "Responsibilities" text = "Responsibilities" func={animateTextSwoosh}/>
...
export const MainSectionData = (
  <div>
    ...
    <div className='TextImageBox'>
      ...
      <Paragraph title = "About me" id = "AboutMeText" text = "I'm a 3rd year Business Marketing student at Cal Poly Pomona interested in joining a motivated tech sales team."/>
    </div>
    <div className='TextImageBox'>
    ...
    <div style={{padding: "4em"}}>
      <TextSlide id="BigWhy" text = "Why learn computer science to go into business?" func={animateSlipper}/>
      <Image image = {CImage}  class = "CImage" caption = "BlackJack with Ncurses, one of the first C programs I created"/>
      <Paragraph id = "InterestsText" text = "I've always had an analytical and entrepreneurial mindset, which lead me to realize the ease to market and scale a software related business. Being that I already devote a large amount of my time to my formal education in business, I choose to spend my free time programming and learning about software, as I know this is the sector I wish to work in."/>
    </div>
