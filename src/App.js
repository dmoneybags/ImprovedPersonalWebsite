...
import './App.css';
import { MainSection, MainSectionData, ProjectData, ArticleSection, ExtraData, ResumeData, AboutData} from "./index.js";
  ...
  return (
    <BrowserRouter basename="/">
      <Routes>
         ...
         <Route path="/about" element = {<MainSection elements = {AboutData}/>}/>              
      </Routes>
   </BrowserRouter>
  );
}
